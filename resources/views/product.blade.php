                ...
                <div class="flex items-center justify-between px-4 py-2 bg-gray-900">
                    ...
                    <div class="inline-flex">
                        ...
                        <form action="{{ route('product.destroy',['product'=>$productData->id]) }}" method="post">
                            @csrf
                            @method('delete')
                            <button type="submit" id="delete-product" class="px-2 py-1 text-xs font-semibold text-gray-900 uppercase transition-colors duration-200 transform bg-white border-t border-b border-r border-gray-800 rounded-r hover:bg-gray-200 focus:bg-gray-400 focus:outline-none">
